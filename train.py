...
def train_one_epoch(model, loader, criterion, optimizer, scaler, scheduler, device, epoch, cfg):
...
def train(model, train_loader, val_loader, cfg):
    ...
    for epoch in range(cfg.NUM_EPOCHS):
        ...
        print(f"Epoch [{epoch+1:03d}/{cfg.NUM_EPOCHS}] Time: {epoch_time:.0f}s | LR: {lr_curr:.6f}")
